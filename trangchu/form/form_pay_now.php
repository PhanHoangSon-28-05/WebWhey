...
<div class="container-fluid" style="padding-top: 5px;">
    ...
    <div class="row" id="khung_gia_sp">
        ...
        <div class="col-sm-8">
            ...
            <p>Số lương: <input type="number" name="SoLuong" style="width: 60px; height: 40px;"
              value="1"></p>
            ...
            <input name="name_use"  type="text" class="form-control" style="display: inline-block; width:400px;height: 40px; font-size: 30px;"placeholder="Nhập tên người nhận" value="<?php echo $_SESSION['TenKhachHang'];?>" required></br> 
            <p style="display: inline-block; margin-right: 10px;">Địa chỉ nhận hàng: </p>
            <input name="Address"  type="text" class="form-control" style="display: inline-block; width: 500px;" placeholder="Nhập địa chỉ" required></br> 
            <p style="display: inline-block; margin-right: 10px;">Số điện thoại: </p>
            <input name="SDT"  type="text" class="form-control" style="display: inline-block; width: 500px;" placeholder="Nhập số điện thoại" value="<?php echo $_SESSION['SDT'];?>" required></br> 
            <p style="display: inline-block; margin-right: 10px;">Ghi chú:</p>
            <input name="GhiChu"  type="text" class="form-control" style="display: inline-block; width: 500px;" placeholder="Yêu cầu hàng hóa"></br>           
        </div>
        <script>
            ...
            input.onchange = function() {
                ...
                tongcong.textContent ="Tổng tiền: " + newTongCong.toLocaleString('vi', {style: 'currency', currency: 'VND'});
            }
        </script>
        
            <a href="" class="text-right" style="text-align: center;"><button type="submit"
            name="form_click_HD" value="save" class="btn btn-outline-success mb-3 btn-lg">Thanh Toán</button></a>
        </form>
