...
function whey(){
    ...
    if (mysqli_num_rows($kq) > 0) {
        ?><a href="./index.php?admin=loaisp&IDLoai=<?php echo mysqli_fetch_array($kq_l)['IDLoai']?>" style="text-decoration: none"> <h1>Whey Protein </h1></a><?php
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 mt-2">
                ...
                <div class="">
                    <div class="product_box">
                        ...
                        <a href="./index.php?admin=view_sanpham&IDSanPham=<?php echo $row['IDSanPham'];?>"><img style="height: 200px; width: 200px;" src="<?php echo $row['Hinh'];?>" alt="Shoes 1" /></a>
                        ...
                        <?php }else{ ?>
                            ...
                            <p class="text-center"><a href="./index.php?admin=pay_now&IDSanPham=<?php echo $row['IDSanPham'];?>&IDTaiKhoan=<?php echo $_SESSION['IDTaiKhoan'];?>" class="text-right"><button  type="submit" name="form_click_pay_now" value="save" class="btn btn-outline-success mb-3 btn-lg"> Mua ngay</button></a></p>
                            <?php }?>
                    </div>
                </div>
            </div>
...
function Mass(){
    ...
    $kq_l = mysqli_query($con,$sql_l);
    if (mysqli_num_rows($kq) > 0) {
        ?><a href="./index.php?admin=loaisp&IDLoai=<?php echo mysqli_fetch_array($kq_l)['IDLoai']?>" style="text-decoration: none"> <h1> Mass tăng cân </h1></a><?php
        while ( $row = mysqli_fetch_array($kq) and $dem < 4) {
            ?>
            <div class="col-lg-3 col-md-6 col-sm-12 mt-2">
                <!--col-4 = 12/4-->
...
function Pre_workout_Creatin(){
    include('..\connet.php');
    $dem  = 0;
    $sql = "SELECT * FROM `sanpham` sp, giasanpham gsp, nhacungcap ncc, loai l, thuoctinh tt WHERE sp.IDSanPham = gsp.IDSanPham and ncc.IDNhaCungCap = sp.IDNhaCungCap and l.IDLoai = sp.IDLoai and sp.IDThuocTinh = tt.IDThuocTinh and l.TenLoai = 'Pre-workout, Creatine' and sp.TrangThai = 'Bán Chạy'ORDER by sp.IDSanPham DESC";
    $kq = mysqli_query($con, $sql);
    $sql_l = "SELECT * FROM loai WHERE TenLoai = 'Pre-workout, Creatine'";
    $kq_l = mysqli_query($con,$sql_l);
    if (mysqli_num_rows($kq) > 0) {
        
        ?><a href="./index.php?admin=loaisp&IDLoai=<?php echo mysqli_fetch_array($kq_l)['IDLoai']?>" style="text-decoration: none"><h1>  Pre-workout, Creatine </h1></a> <?php
        while ($row = mysqli_fetch_array($kq) and $dem < 4) {
            ?>
            <div class="col-lg-3 col-md-6 col-sm-12 mt-2">
                <!--col-4 = 12/4-->
...
function Amino_Acid_BCAAs(){
    include('..\connet.php');
    $dem  = 0;
    $sql = "SELECT * FROM `sanpham` sp, giasanpham gsp, nhacungcap ncc, loai l, thuoctinh tt WHERE sp.IDSanPham = gsp.IDSanPham and ncc.IDNhaCungCap = sp.IDNhaCungCap and l.IDLoai = sp.IDLoai and sp.IDThuocTinh = tt.IDThuocTinh and l.TenLoai = 'Amino Acid, BCAAs' and sp.TrangThai = 'Bán Chạy' ORDER by sp.IDSanPham DESC";
    $kq = mysqli_query($con, $sql);
    $sql_l = "SELECT * FROM loai WHERE TenLoai = 'Amino Acid, BCAAs'";
    $kq_l = mysqli_query($con,$sql_l);
    if (mysqli_num_rows($kq) > 0) {
        ?><a href="./index.php?admin=loaisp&IDLoai=<?php echo mysqli_fetch_array($kq_l)['IDLoai']?>" style="text-decoration: none"><h1> Amino Acid, BCAAs </h1></a>   <?php
        while ($row = mysqli_fetch_array($kq) and $dem < 4) {
            ?>
            <div class="col-lg-3 col-md-6 col-sm-12 mt-2">
                <!--col-4 = 12/4-->
...
function Vitamin(){
    include('..\connet.php');
    $dem  = 0;
    $sql = "SELECT * FROM `sanpham` sp, giasanpham gsp, nhacungcap ncc, loai l, thuoctinh tt WHERE sp.IDSanPham = gsp.IDSanPham and ncc.IDNhaCungCap = sp.IDNhaCungCap and l.IDLoai = sp.IDLoai and sp.IDThuocTinh = tt.IDThuocTinh and l.TenLoai = 'Vitamin' and sp.TrangThai = 'Bán Chạy' ORDER by sp.IDSanPham DESC";
    $kq = mysqli_query($con, $sql);
    $sql_l = "SELECT * FROM loai WHERE TenLoai = 'Vitamin'";
    $kq_l = mysqli_query($con,$sql_l);
    if (mysqli_num_rows($kq) > 0) {
        ?> <a href="./index.php?admin=loaisp&IDLoai=<?php echo mysqli_fetch_array($kq_l)['IDLoai']?>" style="text-decoration: none"><h1> Vitamin </h1></a>  <?php
        while ($row = mysqli_fetch_array($kq) and $dem < 4) {
            ?>
            <div class="col-lg-3 col-md-6 col-sm-12 mt-2">
                <!--col-4 = 12/4-->
...
function GiamMo(){
    include('..\connet.php');
    $dem  = 0;
    $sql = "SELECT * FROM `sanpham` sp, giasanpham gsp, nhacungcap ncc, loai l, thuoctinh tt WHERE sp.IDSanPham = gsp.IDSanPham and ncc.IDNhaCungCap = sp.IDNhaCungCap and l.IDLoai = sp.IDLoai and sp.IDThuocTinh = tt.IDThuocTinh and l.TenLoai = 'Giảm Mỡ' and sp.TrangThai = 'Bán Chạy' ORDER by sp.IDSanPham DESC";
    $kq = mysqli_query($con, $sql);
    $sql_l = "SELECT * FROM loai WHERE TenLoai = 'Giảm Mỡ'";
    $kq_l = mysqli_query($con,$sql_l);
    if (mysqli_num_rows($kq) > 0) {
        ?><a href="./index.php?admin=loaisp&IDLoai=<?php echo mysqli_fetch_array($kq_l)['IDLoai']?>" style="text-decoration: none"><h1> Giảm Mỡ </h1></a>  <?php
        while ($row = mysqli_fetch_array($kq) and $dem < 4) {
            ?>
            <div class="col-lg-3 col-md-6 col-sm-12 mt-2">
                <!--col-4 = 12/4-->
