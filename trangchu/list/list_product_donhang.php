...
<div class="container-fluid">
  <h1 class="text-center text-dark ">Danh Đơn Hàng</h1>
  <table class="table table-bordered table-hover table-dark">
    ...
    <tbody>
      <?php 
            ...
            $sql = "SELECT * from hoadonbanhang hdbh, thongtinkhachang ttkh, taikhoan t where ttkh.IDTaiKhoan = t.IDTaiKhoan and hdbh.IDKhachHang = ttkh.IDTaiKhoan and ttkh.IDTaiKhoan = $idtaikhoan";
