            ...
            <div class="col-lg-3 col-md-6 col-sm-12 mt-2">
                ...
                <div class="">
                    <div class="product_box">
                        ...
                        <?php }else{ ?>
                            <p class="text-center" style="float: left;"><a href="./index.php?admin=themsp_loai&IDSanPham=<?php echo $row['IDSanPham'];?>&IDTaiKhoan=<?php echo $_SESSION['IDTaiKhoan'];?>&ID_DS_Loai=<?php echo $id;?>" class="text-right"><button  type="submit" name="form_click_capnhap" value="save" class="btn btn-outline-info mb-3 btn-lg"><i class="fas fa-shopping-cart" style="color: #26e8d2;"></i> Thêm giỏ hàng</button></a></p>

                            <p class="text-center"><a href="./index.php?admin=pay_now&IDSanPham=<?php echo $row['IDSanPham'];?>&IDTaiKhoan=<?php echo $_SESSION['IDTaiKhoan'];?>&ID_DS_Loai=<?php echo $id;?>" class="text-right"><button  type="submit" name="form_click_pay_now" value="save" class="btn btn-outline-success mb-3 btn-lg"> Mua ngay</button></a></p>
                            <?php }?>   
                    </div>
                </div>
            </div>
