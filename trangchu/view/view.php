...
<div class="container-fluid" style="padding-top: 5px;">
    ...
    <div class="row" id="khung_gia_sp">
        ...
        ?>
        <div class="col-sm-4">
            <p class="text-left"><img class="card-img-top" style=" max-width:80%; height:atou; margin-right:20px;"
                    src="<?php echo $row['anhminhhoa'];?>" alt=""></p>
        </div>
        <div class="col-sm-8">
            <p><?php echo preg_replace('/' . preg_quote($row['TenSanPham'], '/') . '/', "<span style='text-decoration: underline;'>".str_replace(' ', '_', $row['TenSanPham'])."</span>", $row['TenSanPham'], 1);?>
            </p>
    ...
    <div class="row" id="khung_thong_tin_sp">
        <p><?php echo preg_replace('/' . preg_quote("Nhà Cung Cấp Sản Phẩm:", '/') . '/', "<strong>Nhà Cung Cấp Sản Phẩm:</strong>", "Nhà Cung Cấp Sản Phẩm:", 1)?>
            <?php echo $row['TenNhaCungCap']; ?></p>
        <p><?php echo $row['MoTaSanPham']; ?></p>
        <p><?php echo preg_replace('/' . preg_quote("Tóm tắt lợt ích:", '/') . '/', "<strong>Tóm tắt lợt ích:</strong>", "Tóm tắt lợt ích:", 1)?>
            <?php echo '<br>'.$row['tomtat']; ?></p>
        <p><?php echo preg_replace('/' . preg_quote("Nội dung sản phẩm:", '/') . '/', "<strong>Nội dung sản phẩm:</strong>", "Nội dung sản phẩm:", 1)?><?php echo '<br>'.nl2br($row['noidung']); ?>
        </p>
    </div>
    ...
    <p class="text-center" style="float: left; margin-left: 30px;"><a href="../" class="text-right"><button
                type="submit" name="form_click_pay_now" value="save" class="btn btn-outline-success mb-3 btn-lg"> Mua
                ngay</button></a></p>
    <?php }else{ ?>
    <p class="text-center" style="float: left;"><a
            ...
            class="text-right"><button type="submit" name="form_click_capnhap" value="save"
                class="btn btn-outline-info mb-3 btn-lg"><i class="fas fa-shopping-cart" style="color: #26e8d2;"></i>
                Thêm giỏ hàng</button></a></p>

    <p class="text-center" style="float: left; margin-left: 30px;"><a
