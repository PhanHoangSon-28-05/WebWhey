<?php
    if (isset($_POST['form_click'])) {
        if ($_POST['NamePost'] != '') {
            ...
            if ($loaitin == "") {
                if ($dich == "" || $dich == null) {
                    $sql_post = "UPDATE `baiviet` SET `tenbaiviet`='$tenpost',`tomtat`='$tomtat',`noidung`='$noidung',`idSanPham`='$sp' WHERE `idbaiviet`='$id_baiviet'";
                }else{
                ...
                if ($dich == "" || $dich == null) {
                    $sql_post = "UPDATE `baiviet` SET `tenbaiviet`='$tenpost',`tomtat`='$tomtat',`noidung`='$noidung',`idloaitin`='$loaitin',`idSanPham`='$sp' WHERE `idbaiviet`='$id_baiviet'";
                }else{
