...
<table class="table table-bordered table-hover table-dark" >
    ...
    <form method="POST" >
      <a href=""><button type="submit" name="form_click_chotdon" value="Update" class="btn btn-outline-primary text-center"><h4>Chốt Đơn</h4></button></a>
    </form>
...
<?php
  if (isset($_POST['form_click_chotdon'])) {
    $sql_upadte = "UPDATE hoadonbanhang SET TinhTrangVanChuyen = 'Đang vận chuyển' where MaHDB = $mahoadon";
    $kq_update = mysqli_query($con, $sql_upadte);
    if ($kq_update ===TRUE) {
      ?>
        <script>
            alert("Đã chốn đơn");
