...
<div class="container ">
  ...
  <table class="table table-bordered table-hover table-dark">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td width="250px"><img class="card-img-top" style=" max-width:50%; height:atou; margin-right:20px;"
            src="<?php echo $row['anhminhhoa'];?>" alt=""></td>
      </tr>
      <?php
                }
            }
  ...
  <a href="?admin=themnoidungsanpham" class="text-right"><button type="submit" name="form_click" value="save"
