        ...
        <div class="col-md-12">
            ...
            <fieldset>
                ...
                <div class="row g-3 align-items-center" style="margin-top:20px; margin-bottom:20px;">
                    ...
                    <div class="col-6">
                        <input name="NameProperties" value="<?php echo $row['Tenthuoctinh']?>" type="text" class="form-control" id="" placeholder="Nhập thuộc tính sản phẩm">
                    </div>  
                </div>

                <p  class="text-center"><a href=""><button type="submit" name="form_click_capnhap" value="save" class="btn btn-outline-success mb-3 btn-lg">Thêm</button></a></p>
                <?php
                    }
                }
