            ...
            <form action="" method="POST">
                <fieldset>
                    <legend class="text-center"
                        style="font-size:50px; margin-top:20px; margin-bottom:40px; color:black; font-style: bold;">GIÁ
                        SẢN PHẨM</legend>
                    <!-- Name Product -->
                    ...
                    <div class="row g-3 align-items-center" style="margin-top:20px; margin-bottom:20px;">
                        ...
                        <div class="col-auto">
                            <input name="EntryPrice" type="number" class="form-control" id=""
                                placeholder="Nhập giá khi nhận hàng" value="<?php echo $row1['GiaNhap'];?>">
                        </div>
                    </div>
                    <!-- Price -->
                    <div class="row g-3 align-items-center" style="margin-top:20px; margin-bottom:20px;">
                        ...
                        <div class="col-auto">
                            <input name="Price" type="number" class="form-control" id=""
                                placeholder="Nhập giá bán ra thị trường" value="<?php echo $row1['GiaBan'];?>">
                        </div>
                    </div>
