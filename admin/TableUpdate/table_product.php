        ...
        ?>
            ...
            <fieldset>
                ...
                <div class="row g-3 align-items-center" style="margin-top:20px; margin-bottom:20px;">
                    ...
                    <div class="col-6">
                        <input name="NameProduct"  type="text" class="form-control" id="" placeholder="Nhập tên sản phẩm" value="<?php echo $row1['TenSanPham'];?>">
                    </div>  
                </div>
                <!-- Image Product -->
                <div class="row g-3 align-items-center" style="margin-top:20px; margin-bottom:20px;">
                    ...
                    <div class="col-auto">
                        <input class="form-control-sm"  style="size:50px;" type="file" name="ImgProduct" id="" required="required">
                    </div>  
                </div>
                <!-- Name Type -->
                <div class="row g-3 align-items-center" style="margin-top:20px; margin-bottom:20px;">
                ...
                <div class="row g-3 align-items-center" style="margin-top:20px; margin-bottom:20px;">
                    ...
                    <div class="col-6">
                        <select style="height:30px; font-size: 20px;" name="idthuoctinh" id="">
                            <option value="<?php echo $row1['IDThuocTinh'];?>"><?php echo $row1['Tenthuoctinh'];?></option>
                            <?php
                ...
                <div class="row g-3 align-items-center" style="margin-top:20px; margin-bottom:20px;">
                    ...
                    <div class="col-6">
                        <select style="height:30px; font-size: 20px;" name="idnhacungcap" id="">
                            <option value="<?php echo $row1['IDNhaCungCap'];?>"><?php echo $row1['TenNhaCungCap'];?></option>
                            <?php
                ...
                <div class="form-group" style="margin-top:20px; margin-bottom:20px;">
                    <tr>
                        ...
                        <td><textarea name="ProductDescription" id="ProductDescription" class="form-control" rows="5" required="required"><?php echo $row1['MoTaSanPham'];?></textarea></td>
                    </tr> 
                </div>
                <!-- Status -->
                <div class="row g-3 align-items-center" style="margin-top:20px; margin-bottom:20px;">
                    ...
                    <div class="col-3">
                        <input name="Status"  type="text" class="form-control" id="" placeholder="Còn hàng, hết hàng, bán chạy" required="required" value="<?php echo $row1['TrangThai'];?>">
                    </div>  
                </div>
